...
export default function AdminDashbord() {
  return (
    ...
    <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400" >
       <NavLink className="text-decoration-none"  to={"/AdminDashboard/students"}>
        <li className="mr-2">
       ...
       <NavLink className="text-decoration-none"  to={"/AdminDashboard/teachers"}>
        <li className="mr-2">
        <p className="inline-flex p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                <svg aria-hidden="true" className="mr-2 w-5 h-5 text-gray-400 dark:text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>Teachers
            </p>
        </li>
       </NavLink>
       <NavLink className="text-decoration-none"  to={"/AdminDashboard/courses"}>
        <li className="mr-2">
        <p className="inline-flex p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
       ...
       <NavLink className="text-decoration-none"  to={"/AdminDashboard/attendance"}>
        <li className="mr-2">
        <p className="inline-flex p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
